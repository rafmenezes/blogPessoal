...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog do Felipe ").description("API Blog Pessoal - Felipe Gustavo")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("http://localhost:8080/swagger-ui/")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Felipe Gustavo", "https://github.com/felipe0059",
				"felipe.nx4@gmail.com");
	}
